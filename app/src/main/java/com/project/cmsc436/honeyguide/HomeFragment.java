...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chirpConnect = new ChirpConnect(getContext(), KEY, SECRET);
            ...
            public void onReceived(byte[] payload, byte channel) {
                if(payload!=null) {
                    ...
                    if(!db.collection("art-pieces").document(new String(payload))
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        if (document.exists()) {
                                            ...
                                            new Toast(getContext()).makeText(getContext(), (String)document.getData().get("Full title"),Toast.LENGTH_LONG).show();
                                        } else {
                                            Log.d(TAG, "No such document");
                                            new Toast(getContext()).makeText(getContext(), "No such document",Toast.LENGTH_LONG).show();
                        ...
                        new Toast(getContext()).makeText(getContext(), "Database Error",Toast.LENGTH_LONG).show();
